...
history = model.fit(X_train, y_train, epochs = 40, batch_size=200, validation_split = 0.2,shuffle = True, verbose = 1, 
...
prediction = pd.DataFrame(pred, columns=['predictions']).to_csv('Prediction1WithoutAnything.csv')
